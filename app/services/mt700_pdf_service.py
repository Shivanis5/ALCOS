...
class MT700PDFService:
    ...
    def generate_pdf(self, data):
        ...
        swift_rows = [
            ...
            [":50: Applicant", data.get("50", "")],

            [":59: Beneficiary", data.get("59", "")],

            [":32B: Currency / Amount", data.get("32B", "")],

            [":39A: Credit Tolerance", data.get("39A", "")],

            [":43P: Partial Shipments", data.get("43P", "")],

            [":43T: Transhipment", data.get("43T", "")],

            [":44A: Place of Taking in Charge", data.get("44A", "")],

            [":44B: Final Destination", data.get("44B", "")],

            [":44C: Latest Shipment Date", data.get("44C", "")],

            [":44E: Port of Loading", data.get("44E", "")],

            [":44F: Port of Discharge", data.get("44F", "")],

            [":45A: Description of Goods", data.get("45A", "")],

            [":46A: Documents Required", data.get("46A", "")],

            [":47A: Additional Conditions", data.get("47A", "")],
